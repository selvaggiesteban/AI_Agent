...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": title, "description": description, "locale": "en" }, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "Section", $$Section, { "variant": "white", "class": "pt-24 pb-16 reveal" }, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto text-center flex flex-col items-center"> <h1 class="font-bold text-[56px] md:text-[86px] leading-tight" style="margin-bottom: 50px;">
Esteban Selvaggi<br><span class="text-primary/60">Computer Engineer</span> </h1> <div class="flex flex-wrap justify-center gap-md"> ${renderComponent($$result3, "Button", $$Button, { "href": "/en/contact" }, { "default": ($$result4) => renderTemplate`Get Started Now` })} ${renderComponent($$result3, "Button", $$Button, { "href": "/en/services", "variant": "secondary" }, { "default": ($$result4) => renderTemplate`View Services` })} </div> </div> ` })}  ${renderComponent($$result2, "Section", $$Section, { "variant": "white", "class": "reveal !py-0", "fullWidth": true }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "ProjectCarousel", $$ProjectCarousel, {})} ` })}  <div class="reveal"> ${renderComponent($$result2, "SkillsSection", $$SkillsSection, {})} </div>  <div class="reveal"> ${renderComponent($$result2, "ReviewsCarousel", $$ReviewsCarousel, {})} </div>  ${renderComponent($$result2, "RecentPosts", $$RecentPosts, {})}  ${renderComponent($$result2, "RecommendedPosts", $$RecommendedPosts, {})} ` })}`;
}, "C:/Users/Esteban Selvaggi/Desktop/subagent-driven_development/scripts/web_designer/example/src/pages/en/index.astro", void 0);
const $$file = "C:/Users/Esteban Selvaggi/Desktop/subagent-driven_development/scripts/web_designer/example/src/pages/en/index.astro";
const $$url = "/en";
