...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let featuredPost = posts.find((post) => getSlug(post.id) === "claude-code-gratis");
  let remainingPosts = posts.filter((post) => getSlug(post.id) !== "claude-code-gratis");
...
}, "C:/Users/Esteban Selvaggi/Desktop/subagent-driven_development/scripts/web_designer/example/src/pages/es/blog/index.astro", void 0);
const $$file = "C:/Users/Esteban Selvaggi/Desktop/subagent-driven_development/scripts/web_designer/example/src/pages/es/blog/index.astro";
const $$url = "/es/blog";
