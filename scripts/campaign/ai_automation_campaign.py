...
def run_ai_automation_campaign(conventions=""):
    ...
    try:
        ...
        if success:
            logger.info("'AI Automations' campaign completed successfully.")
        else:
            logger.error("'AI Automations' campaign failed to send email.")

    except Exception as e:
        logger.exception(f"Critical error in 'AI Automations' campaign: {e}")
